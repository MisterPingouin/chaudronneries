...
const CardsDesktop = () => {
    return (
      <div className="w-[500px] h-auto bg-background-black text-white rounded-lg shadow-lg opacity-65 px-10 py-10">
        ...
        <div className="mr-6 px-3 w-auto h-10 bg-primary text-black rounded-full flex items-center justify-center shadow-lg hover:bg-green-500 transition duration-300 cursor-pointer">
